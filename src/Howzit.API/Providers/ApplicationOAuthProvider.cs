...
namespace Howzit.API.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async System.Threading.Tasks.Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            if (user == null)
            {
                context.SetError("invalid_grant", "The logUser projectName or password is incorrect.");
                return;
            }
        ...
        {
            // Resource userId password credentials does not provide a client ID.
        ...
        /// </returns>
        public override System.Threading.Tasks.Task AuthorizationEndpointResponse(OAuthAuthorizationEndpointResponseContext context)
        {
